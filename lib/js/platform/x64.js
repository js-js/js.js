...
X64.prototype.allocHashMap = function allocHashMap(instr) {
...
X64.prototype.allocObject = function allocObject(instr) {
  var Object = heap.entities.Object;

  this.mov(this.scratch, instr.inputs[0].id);
  this._allocTagged('object', Object.size());
  this.mov(this.heapPtr('rax', Object.offsets.hashmap), this.scratch);
};
