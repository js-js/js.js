...
Base.prototype.declareStub = function declareStub(name, body, config) {
  this.cfgStubs[name] = new Stub(name, body, config);
};

Base.prototype.registerStub = function registerStub(stub) {
  this.cfgStubs[stub.name] = stub;
};

Base.prototype.getStub = function getStub(name) {
