...
Base.prototype.initStubs = stubs.init;
...
Base.prototype.declareCFGStub = function declareCFGStub(name, body, config) {
  this.cfgStubs[name] = new Stub(name, body, config);
};

Base.prototype.registerCFGStub = function registerCFGStub(stub) {
  this.cfgStubs[stub.name] = stub;
};

Base.prototype.getCFGStub = function getCFGStub(name) {
