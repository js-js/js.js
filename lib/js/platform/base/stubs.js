...
function Stub(name, argc, body, config) {
  this.name = name;
  this.argc = argc;
  this.body = body;
  this.fn = null;
...
function declareStub(name, argc, body, config) {
  this.cfgStubs[name] = new this.Stub(name, argc, body, config);
};
...
function propertyStubs() {
  ...
  this.declareStub('getPropertySlot', 3, function() {/*
    block GetPropertySlot
      obj = loadStubArg %0
      prop = loadStubArg %1
  ...
  */}, {
  ...
  ops.forEach(function(op) {
    this.declareStub(op + 'PropertySlot', op === 'store' ? 3 : 2, function() {/*
...
function allocStubs() {
  ...
  this.declareStub('allocField', 1, function() {/*
    block AllocField
  ...
  */}, {
  ...
  this.declareStub('allocHashMap', 0, function() {/*
    block AllocHashMap
  ...
  */}, {
  ...
  this.declareStub('allocObject', 0, function() {/*
    block AllocObject
      hashmap = callStub %"allocHashMap", %0
  ...
  */}, {
  ...
  this.declareStub('allocFn', 1, function() {/*
    block AllocFn
      hashmap = callStub %"allocHashMap", %0
  ...
  */}, {
  ...
  types.forEach(function(type) {
    this.declareStub('allocTagged/' + type, 1, function() {/*
...
function typeStubs() {
  ...
  this.declareStub('isFunction', 1, function() {/*
  ...
  */}, {
  ...
  types.forEach(function(type) {
    this.declareStub('coerce/' + type, 1, function() {/*
...
function binaryStubs() {
  var ops = [ '+', '-', '*' ];
  ops.forEach(function(op) {
    this.declareStub('binary/' + op, 2, function() {/*
