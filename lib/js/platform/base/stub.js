  ...
  ops.forEach(function(op) {
    this.declareStub(op + 'PropertySlot', function() {/*
      ...
      block Attr -> Op
        ...
        t4 = literal %{attrDict.itemSize}
        t5 = smiMul slot, t4
        t6 = literal %{attrDict.value}
        t7 = smiAdd t5, t6
        t8 = literal %{ptrShift}
        t9 = smiShl t7, t8
        t10 = literal %{off}
        ...
        #if op === 'store'
          // Set default meta
          t12 = literal %{(attrDict.attribute - attrDict.value) << ptrShift}
          t13 = smiAdd t11, t12
          meta = literal %{baseDict.attributes['default']}
          smiWriteTagged field, meta, t13
        #endif
      ...
      block NotFound
          ...
          rtId = runtimeId %"getProperty"
          pushArg key
          pushArg obj
          pushArg rtId
          lookup = callStub %"stub", %"runtime", %3
          ret lookup
        #endif
    */}, {
      locals: {
