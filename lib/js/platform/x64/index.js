  ...
  var proc = jit.compile(function() {
    this.Proc(function() {
      ...
      this.spill([ 'rbx', 'r12', 'r13', 'r14', 'r15' ], function() {
        ...
        // Load context (note: 'rdi' === self.context, so previous line should
        // be previous)
        this.mov(self.context, 'rsi');
...
X64.prototype.genGlobal = function genGlobal(instr) {
  ...
  masm.mov(reg, masm.heapPtr(this.context,
                             heap.entities.Context.offsets.global));
};
